...
def create_product(
    ...
    image_path = save_uploaded_file(ImagePath, "app/static/Products/images") if ImagePath else None
    video_path = save_uploaded_file(VideoPath, "app/static/Products/videos") if VideoPath else None
...
def update_product(
    ...
    if ImagePath:
        ...
        product.ImagePath = save_uploaded_file(ImagePath, "app/static/Products/images")

    if VideoPath:
        if product.VideoPath and os.path.exists(product.VideoPath):
            os.remove(product.VideoPath)
        product.VideoPath = save_uploaded_file(VideoPath, "app/static/Products/videos")

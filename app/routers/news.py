...
def create_news(
    ...
    if ImagePath:
        os.makedirs("app/static/News/images", exist_ok=True)
        image_path = f"app/static/News/images/{ImagePath.filename}"
        with open(image_path, "wb") as buffer:
            shutil.copyfileobj(ImagePath.file, buffer)

    if VideoPath:
        os.makedirs("app/static/News/videos", exist_ok=True)
        video_path = f"app/static/News/videos/{VideoPath.filename}"

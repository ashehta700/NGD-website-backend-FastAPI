...
# File Directories
# -------------------------
CONTACT_DIR = "app/static/contact"
REQUEST_DIR = "app/static/requests"
ADMIN_UPLOAD_DIR = "app/static/requests/reply"

for folder in [CONTACT_DIR, REQUEST_DIR, ADMIN_UPLOAD_DIR]:
...
def send_email_with_attachment(subject: str, body: str, to_email: str, attachment_rel: str):
    ...
    full_path = os.path.join(os.getcwd(), "app", "static", attachment_rel)
